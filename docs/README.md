...
- [Runtime approval workflow](./runtime-approval-workflow.md) — provider-neutral approval request/resolution contract for clients and executor callbacks.
...
- [Container image publishing contract](./container-image-publishing.md) — expected service image names, tags, runtime contract, and publish workflow requirements.
...
- [GitHub and Telegram Docker Compose example](./github-docker-compose-example.md) — compose template for API/webhook services, persistent relay queue storage, Telegram adapter routing, and proxy routing.
